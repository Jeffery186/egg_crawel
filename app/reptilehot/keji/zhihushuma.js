...
// 知乎
const zhihushuma = async (ctx) => {
    ctx.app.logger.info("知乎 数码热榜 抓取 => begin");
    ...
    try {
        ...
        await Promise.all([
            ...
            page.goto("https://www.zhihu.com/hot?list=digital", {
        ...
        ctx.app.saveCrawel(`知乎 数码热榜`, dataList);
