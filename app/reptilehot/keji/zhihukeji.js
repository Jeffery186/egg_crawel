...
// 知乎
const zhihukeji = async (ctx) => {
    ctx.app.logger.info("知乎 科学热榜 抓取 => begin");
    ...
    try {
        ...
        await Promise.all([
            ...
            page.goto("https://www.zhihu.com/hot?list=science", {
        ...
        ctx.app.saveCrawel(`知乎 科学热榜`, dataList);
